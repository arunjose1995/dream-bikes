...
//         if (adminLoginDetails.EmailAddress === "") {
//             setAlertEmail(true)
//             setAlertvalidEmail(false)
//         }
//         else {
//             setAlertEmail(false)
//             if (adminLoginDetails.EmailAddress === "anithakutty200@gmail.com") {
//                 setAlertvalidEmail(false)
//             }
//             else {
...
//             }
//         }
//         if (adminLoginDetails.password === "") {
//             setAlertPassword(true)
//             setAlertValidPassword(false)
//         }
//         else {
//             setAlertPassword(false)
//         if(adminLoginDetails.password === "yttuk"){
//             setAlertValidPassword(false)
//         }
//         else{
...
// if(adminLoginDetails.EmailAddress === "anithakutty200@gmail.com" && adminLoginDetails.password === "yttuk"){
...
//                 <h1 style={{ marginLeft: "100px", marginTop: "10px" }}>Admin Login</h1>
...
//                     <Button variant="primary" type="Login" onClick={handleSubmit} style={{ width: "100px", height: "40px", marginLeft: "140px" }}>
//                         Login
//                     </Button>
//                 </div>
            ...
            <div>
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        ...
                        <Dropdown.Item href="#/action-2">Shop Keeper Login</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
            </div>
            <div style={{ padding: "50px" }}>
                ...
                >
                    ...
                    <h3 style={{ marginLeft: "100px" }}>Admin Login</h3>
                    <Form.Group
                        className="mb-2"
